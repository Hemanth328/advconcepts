...
@EnableJpaRepositories(entityManagerFactoryRef = "bookEntityManagerFactory",
                       basePackages = {"com.org.multipledbconnections.repository.book"},
...
public class BookDBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean bookEntityManagerFactory(EntityManagerFactoryBuilder entityManagerFactoryBuilder, @Qualifier("bookDataSource") DataSource dataSource) {
...
//        properties.put("hibernate.dialect", "org.hibernate.dialect.OracleDialect");
        ...
        return entityManagerFactoryBuilder.dataSource(dataSource)
                ...
                .packages("com.org.multipledbconnections.model.book")
